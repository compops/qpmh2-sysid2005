...
##############################################################################
# Setup the Kalman filter algorithm
##############################################################################

# Use the Kalman filter to estimate the log-likelihood
km.filter          = km.kf;
...
# Run the sampler
ppmh0.runSampler(km, sys, th, "pPMH0");

# Write the output to file
ppmh0.fileOutName = 'results/lgss-kf-ppmh0.csv'
ppmh0.writeToFile();
...
# Run the sampler
ppmh1.runSampler(km, sys, th, "pPMH1");

# Write the output to file
ppmh1.fileOutName = 'results/lgss-kf-ppmh1.csv'
ppmh1.writeToFile();
...
# Run the sampler
qpmh2.runSampler(km, sys, th, "qPMH2");

# Write the output to file
qpmh2.fileOutName = 'results/lgss-kf-qpmh2.csv'
qpmh2.writeToFile();
